    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          <a href="#top" className="flex items-center min-w-0" aria-label="Claire's Skincare Studio">
            <span className="font-serif text-xl md:text-2xl tracking-wide truncate">
              Claire<span className="text-gold">'s</span>
              <span className="text-espresso/40 ml-1.5 text-sm font-sans font-light tracking-normal">Skincare Studio</span>
            </span>
          </a>
