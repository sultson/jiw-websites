...
export default function SignatureFacial({ t, onBook }: Props) {
  return (
    <section id="facial" className="relative py-20 md:py-28">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-emerald text-cream p-8 md:p-14 lg:p-20">
          ...
          <div className="relative grid md:grid-cols-5 gap-10 items-center">
            <div className="md:col-span-3">
              <span className="kicker !text-gold-soft">{t('facial.kicker')}</span>
              <h2 className="mt-4 font-serif text-4xl md:text-5xl lg:text-6xl leading-[1.05] text-cream">
                {t('facial.title')}
              </h2>
              <p className="mt-6 text-cream/80 max-w-xl leading-relaxed">{t('facial.body')}</p>
              <button
                onClick={onBook}
