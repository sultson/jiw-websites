...
const workers:Record<string,ReturnType<typeof createFormWorker>>={
  '/api/forms/course':createFormWorker({...common,formPath:'/api/forms/course',subjectPrefix:'Nieuwe opleidingsaanvraag Rescue Watercraft'}),
  ...
  '/api/forms/en/course':createFormWorker({...commonEn,formPath:'/api/forms/en/course',subjectPrefix:'New training request Rescue Watercraft'}),
