  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden px-4 safe-bottom pt-3 pointer-events-none">
      <a
        ...
        className="pointer-events-auto w-full bg-espresso text-cream rounded-lg py-3.5 font-medium flex items-center justify-center gap-2 shadow-[0_10px_30px_-8px_rgba(42,33,32,0.5)]"
      >
