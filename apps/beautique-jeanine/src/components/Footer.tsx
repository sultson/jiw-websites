      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-16 md:py-20">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="space-y-2 text-sm">
            ...
            <a href="tel:+31623669653" className="flex items-center gap-2 hover:text-cream">
              <Phone size={14} /> 06 23669653
            </a>
            <p className="flex items-start gap-2">
              <MapPin size={14} className="mt-0.5 shrink-0" /> Kampweg 13, 8463 VD Rotsterhaule
            </p>
