      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            <a href="#top" className="flex items-baseline gap-2 min-w-0 shrink" aria-label="Beautique Jeanine">
              <span className="font-serif text-lg md:text-2xl italic tracking-tight truncate">
                Beautique <span className="text-gold">Jeanine</span>
              </span>
            </a>
            ...
            <div className="flex items-center gap-1.5 md:gap-3 shrink-0">
              ...
              >
                ...
                <span className="md:hidden">{t('nav.whatsappShort')}</span>
              </a>
              <button
                onClick={() => setOpen(v => !v)}
