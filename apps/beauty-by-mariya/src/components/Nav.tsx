    ...
    <>
      <nav
        className={`sticky top-0 z-50 transition-colors ${
          scrolled
            ? 'bg-pearl/90 backdrop-blur-md border-b border-ink/5'
            : 'bg-pearl/60 backdrop-blur-sm'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            <a href="#top" aria-label="Beauty by Mariya" className="flex items-center min-w-0">
              <span className="font-serif text-xl md:text-2xl tracking-wide text-ink">
                Beauty by <span className="text-rose">Mariya</span>
              </span>
            </a>
      ...
      {open && (
        <div className="lg:hidden fixed inset-x-0 top-16 z-40 bg-pearl border-b border-ink/10 shadow-xl">
