      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        <div className="order-2 md:order-1">
          ...
          <div className="mt-8 flex items-center gap-4 text-sm text-espresso/70">
            ...
            <span className="font-serif italic text-lg">{t('about.signature')}</span>
            <div className="h-px flex-1 bg-espresso/15 max-w-16" />
          </div>
          <p className="mt-3 text-xs uppercase tracking-[0.22em] text-gold">{t('about.welcoming')}</p>
        </div>

        <div className="order-1 md:order-2">
          <div className="relative">
            <div className="rounded-2xl w-full aspect-[4/5] bg-blush overflow-hidden shadow-[0_20px_60px_-30px_rgba(44,26,16,0.35)]">
              <img
                src="/portrait.webp"
                alt="Shiny Nails by Agata Krysińska"
                loading="lazy"
            ...
            <div className="hidden md:block absolute -bottom-8 -left-8 w-40 h-48 rounded-2xl overflow-hidden shadow-[0_20px_60px_-30px_rgba(44,26,16,0.4)] ring-4 ring-cream">
              <img
                src="/nail-01.webp"
                alt="Detail van een gestructureerde manicure"
                loading="lazy"
                className="w-full h-full object-cover"
              />
            </div>
