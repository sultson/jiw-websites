...
export const translations: Record<Lang, Dict> = {
  nl: {
    ...
    'topbar.new': 'Nieuwe behandeling — Head Spa nu beschikbaar',

    'hero.kicker': 'Winkelcentrum Dukenburg',
    'hero.title': 'Rust, precisie en prachtige nagels.',
    'hero.sub': "Verzorgde nagels, pedicure en de nieuwste Head Spa in hart van Nijmegen. Boek zelf online — snel, simpel en zonder bellen.",
    ...
    'usp.headspa': 'Head Spa',
    'usp.headspaSub': 'Uniek in Dukenburg',
    'usp.hygiene': 'Hygiënisch & geurvrij',
    'usp.hygieneSub': 'Eigen, steriele tools',
    'usp.walkin': 'Korte termijn',
    'usp.walkinSub': 'Vaak dezelfde week nog',

    'headspa.kicker': 'Signature behandeling',
    'headspa.title': 'Head Spa — de nieuwe luxe in Dukenburg.',
    'headspa.body': 'Een diepe hoofdhuidreiniging gecombineerd met voedende massage. Ontspant, verfrist en voedt het haar vanaf de wortel.',
    'headspa.cta': 'Boek een Head Spa',
    ...
    'reviews.sub': 'Echte reacties van Google. We lezen elke review.',
    'reviews.all': 'Bekijk alle op Google',

    'about.kicker': 'Over ons',
    'about.title': 'Vietnamees vakmanschap, Nijmeegse warmte.',
    'about.body': "Mykimnails is een kleine, zorgvuldig gerunde salon in Winkelcentrum Dukenburg. MyKim, Kiana en het team combineren Vietnamese precisie met een persoonlijke, rustige aanpak. Bij ons krijg je de tijd — en nagels waar je trots op bent.",
    ...
    'faq.a4': 'We werken met steriele, eigen tools per klant en een ventilatiesysteem dat de salon geurvrij houdt.',
  ...
  en: {
    ...
    'topbar.new': 'New treatment — Head Spa now available',

    'hero.kicker': 'Winkelcentrum Dukenburg',
    'hero.title': 'Calm, precise, beautifully done nails.',
    'hero.sub': 'Manicures, pedicures and the new Head Spa in the heart of Nijmegen. Book online — fast, simple, no phone calls needed.',
    ...
    'usp.ratingSub': 'Google reviews',
    'usp.headspa': 'Head Spa',
    'usp.headspaSub': 'Unique in Dukenburg',
    'usp.hygiene': 'Hygienic & odour-free',
    'usp.hygieneSub': 'Sterile personal tools',
    'usp.walkin': 'Short notice welcome',
    'usp.walkinSub': 'Often same-week slots',

    'headspa.kicker': 'Signature treatment',
    'headspa.title': 'Head Spa — the new luxury in Dukenburg.',
    'headspa.body': 'A deep scalp cleanse combined with a nourishing massage. Relaxes, refreshes and feeds the hair from the root.',
    'headspa.cta': 'Book a Head Spa',
    ...
    'reviews.sub': 'Real quotes from Google. We read every review.',
    'reviews.all': 'See all on Google',

    'about.kicker': 'About us',
    'about.title': 'Vietnamese craftsmanship, Nijmegen warmth.',
    'about.body': 'Mykimnails is a small, carefully run salon in Winkelcentrum Dukenburg. MyKim, Kiana and the team combine Vietnamese precision with a calm, personal approach. You get the time you deserve — and nails you are proud of.',
    ...
    'faq.a4': 'We use sterile, personal tools per client and a ventilation system that keeps the salon odour-free.',
