...
const images = [
  ...
  { src: '/done-nails-3.webp', alt: 'Cat eye nagels', cls: 'aspect-square' },
  { src: '/done-nails-5.webp', alt: 'BIAB afwerking', cls: 'aspect-[4/3]' },
  { src: '/done-nails-6.webp', alt: 'Nail art detail', cls: 'aspect-[4/3]' },
];
