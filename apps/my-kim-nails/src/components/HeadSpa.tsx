...
export default function HeadSpa({ t, onBook }: Props) {
  return (
    <section id="head-spa" className="relative py-20 md:py-28">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-emerald text-cream p-8 md:p-14 lg:p-20">
          ...
          <div className="relative grid md:grid-cols-5 gap-10 items-center">
            <div className="md:col-span-3">
              <span className="kicker !text-gold-soft">{t('headspa.kicker')}</span>
              <h2 className="mt-4 font-serif text-4xl md:text-5xl lg:text-6xl leading-[1.05] text-cream">
                {t('headspa.title')}
              </h2>
              <p className="mt-6 text-cream/80 max-w-xl leading-relaxed">{t('headspa.body')}</p>
              <button
                onClick={onBook}
            ...
            <div className="md:col-span-2 flex md:justify-end">
              <div className="w-36 h-36 md:w-56 md:h-56 rounded-full bg-emerald-soft/30 flex items-center justify-center">
                <Leaf size={80} className="text-gold-soft md:w-28 md:h-28" strokeWidth={1} />
              </div>
            </div>
          </div>
        </div>
