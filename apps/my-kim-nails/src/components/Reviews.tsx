    ...
    <section id="recensies" className="py-20 md:py-28 bg-blush-soft/50">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div className="mt-8 text-center">
          <a
            href="https://www.google.com/maps/place/Mykimnails+Dukenburg/@51.8229535,5.7933,17z/data=!4m8!3m7!1s0x47c7079efde349b3:0x66d3031b3edc53dd!8m2!3d51.8229502!4d5.7958749!9m1!1b1!16s%2Fg%2F11xd3ks5k7"
            target="_blank"
