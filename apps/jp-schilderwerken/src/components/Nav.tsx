...
const links = [
  ...
  { href: '#over', label: 'Over JP' },
  { href: '#contact', label: 'Contact' },
];

function Wordmark() {
  return (
    <a href="#top" className="flex items-center gap-3" aria-label="JP Schilderwerken home">
      <img src="/logo-compact.png" alt="" className="h-10 w-10" />
      <span className="flex flex-col leading-none">
        <span className="font-display text-2xl text-ink">JP</span>
