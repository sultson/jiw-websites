...
function Contact() {
  ...
  const intro =
    'Bel, mail of stuur een WhatsApp voor een vrijblijvend gesprek. We komen graag langs voor een gratis kennismaking.';
      ...
      <div className="container-page">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          ...
          <div>
            ...
            <ul className="mt-8 space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 mt-1 text-saffron shrink-0" />
                <div>
              ...
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 mt-1 text-saffron shrink-0" />
                <div className="flex flex-wrap items-center gap-2">
                  <a href={business.phone.href} className="hover:text-saffron-deep">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-sm text-saffron-deep hover:underline"
                  >
              ...
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 mt-1 text-saffron shrink-0" />
                <a href={business.email.href} className="hover:text-saffron-deep">
                  {business.email.display}
                </a>
              </li>
              <li className="flex items-start gap-3">
                <FileText className="w-5 h-5 mt-1 text-saffron shrink-0" />
          ...
          <div className="bg-bone-soft rounded-2xl p-6 md:p-8 border border-line">
            ...
            <h3 className="font-display text-xl md:text-2xl mt-8">Diploma's</h3>
            <ul className="mt-4 space-y-2">
              {business.certificates.map((cert) => (
                <li key={cert} className="flex items-start gap-2">
                  <BadgeCheck className="w-5 h-5 mt-0.5 text-saffron shrink-0" />
                  <span>{cert}</span>
                </li>
              ))}
            </ul>
        ...
        {/* Map */}
        <iframe
          src="https://www.google.com/maps?q=Molenaarserf+57+Houten&output=embed"
          loading="lazy"
          referrerPolicy="no-referrer-when-downgrade"
          title="Kaart JP Schilderwerken"
        ...
        <div className="container-page">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <img
                src="/logo-black.png"
                alt="JP Schilderwerken"
                className="h-10 w-auto invert"
              />
              <p className="mt-4 text-bone/70 text-sm">Schilder uit Houten</p>
              <p className="mt-3 text-bone/60 text-xs leading-relaxed">
                Vak geleerd bij{' '}
                <a
                  href={business.fatherCompany.url}
                  target="_blank"
                  rel="noreferrer"
                  className="text-bone/80 underline-offset-2 hover:underline hover:text-bone"
                >
                  {business.fatherCompany.name}
                </a>
                .
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-sm text-bone/70">
            <p>
              © {currentYear} JP Schilderwerken · KVK {business.kvk} · Site door{' '}
              <a
