...
const iconByKey: Record<string, LucideIcon> = {
  ...
  houtrot: Wrench,
  behangen: Layers,
  'behang-verwijderen': Sparkles,
  gevelbeplating: Square,
  beits: TreeDeciduous,
};
      ...
      <div className="container-page">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-stone text-base md:text-lg leading-relaxed">
            Van plafond tot kozijn, van behang tot houtrot. Binnen en buiten, spuitwerk en
            voorbehandeling.
          </p>
        </div>
        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-6">
          {services.map((service) => {
            ...
            return (
              <article
                key={service.key}
                className="group flex flex-col gap-4 p-6 rounded-2xl bg-bone border border-line transition-all duration-200 hover:-translate-y-1 hover:border-saffron hover:shadow-[0_16px_40px_-20px_rgba(26,26,26,0.25)]"
              >
