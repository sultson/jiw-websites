...
const formWorker = createFormWorker({
  ...
  siteName: 'Kok Vastgoedonderhoud',
  senderName: 'Kok Vastgoedonderhoud',
  subjectPrefix: 'Nieuwe aanvraag Kok Vastgoedonderhoud',
  confirmationFollowUpSentence:
    'Wij nemen binnen één werkdag contact op om uw aanvraag door te nemen en, als het past, een opname op locatie in te plannen.',
  ...
  emailFields: [
    ...
    { name: 'startWindow', label: 'Gewenste startperiode' },
  ],
