        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            <span className="font-serif text-2xl text-cream">
              Elégance <span className="text-gold-soft">Nails</span>
            </span>
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="flex items-start gap-2">
              ...
              Laan door Hoevelaar 44, 3931 GK Woudenberg
            </p>
            <a href="tel:+31682813832" className="flex items-center gap-2 hover:text-cream">
          ...
          <div className="space-y-2 text-sm">
            ...
            >
              <Instagram size={14} className="text-gold-soft" /> @elegancenailsstudio_
            </a>
            <a
              href="https://www.facebook.com/p/El%C3%A9gance-Nails-61584542070604/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 hover:text-cream"
            >
              <Facebook size={14} className="text-gold-soft" /> Elégance Nails
            </a>
