...
const chips = [
  `${business.yearsExperience} jaar ervaring`,
...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Saffron blob for depth */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-24 -right-24 h-[28rem] w-[28rem] rounded-full bg-saffron opacity-20 blur-3xl"
      />
      <div
        aria-hidden="true"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 items-center">
          ...
          <div className="md:col-span-5">
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-[0_30px_60px_-30px_rgba(15,26,46,0.45)]">
                <img
                  src="/buiten.webp"
                  alt="Strak buitenschilderwerk aan een woning in Hellevoetsluis"
              ...
              <div className="absolute -bottom-6 -left-4 md:-left-8 bg-paper border border-line rounded-xl px-4 py-3 shadow-[0_20px_40px_-20px_rgba(15,26,46,0.35)]">
