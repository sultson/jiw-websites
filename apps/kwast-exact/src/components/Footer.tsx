...
function Contact() {
  ...
  const intro =
    'Bel of mail voor een vrijblijvend gesprek. We reageren binnen 1 uur en komen graag langs voor een gratis kennismaking.';
  ...
  return (
    <section id="contact" className="section bg-bone">
      <div className="container-page">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          ...
          <div>
            ...
            <ul className="mt-8 space-y-4">
              ...
              <li className="flex items-start gap-3">
                <Smartphone className="w-5 h-5 mt-1 text-saffron shrink-0" />
                <div className="flex flex-wrap items-center gap-2">
                  <a href={business.mobile.href} className="hover:text-saffron-deep">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-sm text-saffron-deep hover:underline"
                  >
                    WhatsApp
                  </a>
                </div>
          ...
          <div className="bg-bone-soft rounded-2xl p-6 md:p-8 border border-line">
            ...
            <h3 className="font-display text-xl md:text-2xl mt-8">Certificaten</h3>
        ...
        {/* Map */}
        <iframe
          src="https://www.google.com/maps?q=Moerbeigaarde+14+Hellevoetsluis&output=embed"
          loading="lazy"
          referrerPolicy="no-referrer-when-downgrade"
          title="Kaart Kwast Exact"
      ...
      <footer className="bg-ink text-bone py-12">
        <div className="container-page">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className="font-display text-xl">Kwast Exact</span>
              </div>
              <p className="mt-3 text-bone/70 text-sm">Schilder uit Hellevoetsluis</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-sm text-bone/70">
            <p>
              © {currentYear} Kwast Exact · KVK {business.kvk} · Site door{' '}
              <a
