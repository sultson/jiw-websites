      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="order-1 md:order-2">
          <div className="relative">
            <img
              src="/werk-roze-glitter.webp"
              alt="Amandelvormige nagels in zacht roze met goudkleurige glitter french, gemaakt bij Nailtique by Linn"
              loading="lazy"
              className="rounded-sm w-full aspect-[4/5] object-cover shadow-[0_20px_60px_-30px_rgba(43,36,33,0.5)]"
            />
            <div className="hidden md:block absolute -bottom-6 -left-6 w-32 h-32 rounded-sm bg-blush -z-0" />
