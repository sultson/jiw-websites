...
const formWorker = createFormWorker({
  ...
  ownerName: 'Tarek',
  senderName: 'MT Bouw',
  subjectPrefix: 'Nieuwe prijsindicatie MT Bouw',
  confirmationFollowUpSentence:
    'We nemen binnen 1 uur contact met u op om uw aanvraag door te nemen en een gratis kennismaking in te plannen.',
  ...
  emailFields: [
    ...
    { name: 'timing', label: 'Gewenste start' },
  ],
