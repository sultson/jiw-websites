  ...
  return (
    <section id="contact" className="section bg-bone">
      <div className="container-page">
          ...
          <div>
            ...
            <ul className="mt-8 space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href={business.phone.href} className="hover:text-saffron-deep font-semibold">
        ...
        {/* Map */}
        <iframe
          src="https://www.google.com/maps?q=Henri+Ter+Hallsingel+22+Rijswijk&output=embed"
          loading="lazy"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <div className="flex items-center gap-3">
                <img src="/logo-mark-light.png" alt="" className="w-9 h-9" />
                <span className="font-display text-xl">MT Bouw</span>
              </div>
              <p className="mt-3 text-bone/70 text-sm">Schilder en bouw uit Rijswijk</p>
            </div>
            ...
            <div className="space-y-2 text-bone/70 text-sm">
              <a href={business.phone.href} className="block hover:text-bone font-semibold">
                {business.phone.display}
              </a>
              <p>
              ...
              <p>
                {business.reviewsScore} op {business.reviewsCount} reviews
              </p>
            </div>
          </div>
