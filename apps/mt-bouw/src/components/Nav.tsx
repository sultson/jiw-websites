...
function Wordmark() {
  return (
    <a href="#top" className="flex items-center gap-3" aria-label="MT Bouw home">
      <img src="/logo-mark.png" alt="" className="h-10 w-10" />
      <span className="flex flex-col leading-none">
        <span className="font-display text-2xl text-ink">MT Bouw</span>
        <span className="font-sans text-[10px] tracking-[0.28em] text-stone uppercase mt-0.5">
          Rijswijk
        </span>
      </span>
    </a>
      ...
      <div className="container-page flex items-center justify-between py-4 md:py-5">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-1.5 text-sm font-semibold text-ink hover:text-saffron-deep"
          >
            <Phone size={16} />
