...
const formWorker = createFormWorker({
  ...
  siteName: 'SQM Bouwmanagement',
  senderName: 'SQM Bouwmanagement',
  subjectPrefix: 'Nieuwe aanvraag SQM Bouwmanagement',
  confirmationFollowUpSentence: 'Wij nemen binnen één werkdag contact op om uw vraag door te nemen en een opname op locatie in te plannen.',
