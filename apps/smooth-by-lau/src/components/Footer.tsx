        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="flex items-start gap-2">
              ...
              Berkendreef 11B, 5165 AT Waspik
            </p>
            <a href="tel:+31638502903" className="flex items-center gap-2 hover:text-cream">
          ...
          <div className="space-y-2 text-sm">
            ...
            <a
              href="https://www.instagram.com/smoothbylau/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 hover:text-cream"
            >
              <Instagram size={14} className="text-gold-soft" /> @smoothbylau
            </a>
            <a
              href="https://www.facebook.com/p/Smooth-By-Lau-61561099216726/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 hover:text-cream"
            >
