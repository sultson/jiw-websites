      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-16 md:py-20">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="space-y-2 text-sm">
            ...
            <a href="tel:+31614020035" className="flex items-center gap-2 hover:text-cream">
              <Phone size={14} /> 06 14020035
            </a>
            <p className="flex items-start gap-2">
              <MapPin size={14} className="mt-0.5 shrink-0" /> Erfsebosweg 45, 6598 AJ Heijen
            </p>
