      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          <div className="card p-6 md:p-8 space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Erfsebosweg+45+Heijen"
                  target="_blank"
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a href="tel:+31614020035" className="font-medium text-espresso mt-1 block hover:text-gold">
                  06 14020035
                </a>
                <a
                  href="https://wa.me/31614020035"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="rounded-2xl overflow-hidden border border-espresso/5 min-h-[360px] md:min-h-full">
            <iframe
              title="JOY&apos;S complete nagelverzorging op Google Maps"
              src="https://www.google.com/maps?cid=15787350371802125352&output=embed"
              width="100%"
              height="100%"
