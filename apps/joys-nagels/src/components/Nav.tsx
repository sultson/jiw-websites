      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            <a href="#top" className="flex items-baseline gap-2 min-w-0" aria-label="JOY&apos;S complete nagelverzorging">
              <span className="font-serif text-xl md:text-2xl italic tracking-tight truncate">
                <span className="text-gold">JOY'S</span> nagels
              </span>
            </a>
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              >
                <Phone size={16} />
                <span className="hidden md:inline">06 14020035</span>
