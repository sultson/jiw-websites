...
Object.assign(globalThis, {
  ...
  location: {hostname: 'winterswijkvakantiehuis.nl', origin: 'https://winterswijkvakantiehuis.nl'},
  window: {location: {
  ...
  document: {
    title: 'Vakantiehuizen in Winterswijk',
    referrer: 'https://example.com/private?email=guest@example.com',
    cookie: '_ga=sample; _ga_J9G5MV9W28=sample',
    createElement: () => ({remove() {}}),
    head: {append: (script: any) => scripts.push(script)},
    getElementById: () => ({remove() {}}),
  },
});
const details = {site_language: 'nl', page_type: 'landing', destination: 'winterswijk', home_id: 'none'};
