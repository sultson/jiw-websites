  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 right-5 z-30 inline-flex items-center gap-2.5 rounded-full bg-wijn px-5 py-3.5 font-semibold text-white shadow-lg transition hover:bg-wijn-diep"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
          <button
            ...
            className="absolute inset-0 bg-wijn-diep/40 backdrop-blur-[2px]"
          />
          <div
            ref={venster}
            role="dialog"
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-inkt/70">
              ...
              <button
                ...
                onClick={() => setOpen(false)}
                aria-label="Sluiten"
                className="grid h-10 w-10 flex-none place-items-center rounded-full border border-inkt/20 text-inkt transition hover:bg-white"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="mt-6 flex flex-wrap gap-3 border-t border-lijn pt-5">
              <a
                href={TEL_LINK}
                className="inline-flex items-center gap-2 rounded-full border border-inkt/25 px-5 py-2.5 font-semibold text-inkt transition hover:bg-white"
              >
