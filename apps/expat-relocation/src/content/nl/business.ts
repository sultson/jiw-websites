...
export const business: SectionContent = {
  ...
  metaTitle: 'Een bedrijf starten in Nederland | E & I Expat Services',
  metaDescription:
    'Start of verplaats een bedrijf in Nederland met één partner voor visa, bedrijfsregistratie, woonruimte en gezinsrelocation. Gebouwd voor internationale ondernemers.',
  eyebrow: 'Business',
  intro: [
  ...
  cta: {
    ...
    label: 'Plan mijn bedrijfsverhuizing',
  },
  services: [
    {
      slug: 'starting-a-business-in-the-netherlands',
      menuLabel: 'Bedrijf starten',
      title: 'Een bedrijf starten in Nederland',
      ...
      included: {
        title: 'Wat de routekaart dekt',
        blocks: [
          {
            title: 'Verblijfsstrategie',
            text: 'Startup visum, DAFT voor Amerikanen, de vergunning voor zelfstandigen of helemaal geen vergunning voor EU-burgers. Wij bepalen de basis die past bij uw nationaliteit en uw plannen.',
          },
          {
            title: 'Advies over de rechtsvorm',
            text: 'Eenmanszaak of BV, uitgelegd in termen van aansprakelijkheid, belastingen en hoe elke keuze samenhangt met uw immigratieroute.',
          },
          {
            title: 'Registraties op volgorde',
            text: 'KvK, btw-nummer van de Belastingdienst, zakelijke bankrekening en verzekeringen, zo gerangschikt dat niets iets anders blokkeert.',
          },
          {
            title: 'Het leven rond het bedrijf',
            text: 'Een woonplek, inschrijving bij uw gemeente, zorg en gezinszaken, want een oprichter die niet kan settelen kan niet bouwen.',
          },
        ],
      },
      process: {
      ...
      faq: {
        title: 'Oprichters vragen ons',
        items: [
          {
            q: 'Kan ik een Nederlands bedrijf starten zonder in Nederland te wonen?',
            a: 'U kunt een Nederlands bedrijf vanuit het buitenland bezitten, maar het lokaal runnen vereist als niet-EU-burger een verblijfsbasis. Wij helpen u beslissen of u werkelijk moet verhuizen, en zo ja, op welke vergunning.',
          },
          {
            q: 'Heb ik een Nederlandse zakenpartner nodig?',
            a: 'Nee. Nederland vereist voor de meeste structuren geen lokale aandeelhouders of bestuurders. Uw bedrijf kan volledig van u zijn.',
          },
          {
    ...
    },
    {
      ...
      menuLabel: 'Bedrijfsoprichting',
      title: 'Bedrijfsregistratie Nederland',
      metaTitle: 'Bedrijfsregistratie Nederland voor buitenlandse oprichters',
      metaDescription:
        'Registreer uw Nederlandse bedrijf zonder misstappen: rechtsvorm, notaris, KvK, btw en bankrekening, persoonlijk begeleid voor buitenlandse oprichters en internationale firma’s.',
      eyebrow: 'Bedrijfsoprichting',
      intro: [
        'Een Nederlands bedrijf registreren is mechanisch eenvoudig en strategisch makkelijk fout te doen. De rechtsvorm die u op dag één kiest, bepaalt uw aansprakelijkheid, uw belastingpositie en, voor buitenlandse oprichters, hoe soepel uw verblijf en bankzaken daarna op hun plek vallen.',
      ...
      forWho: {
        ...
        items: [
          'Buitenlandse oprichters die hun eerste Nederlandse entiteit vestigen',
          'Internationale bedrijven die een Nederlands filiaal of dochteronderneming openen',
          'DAFT- en startupvisumaanvragers van wie de vergunning afhangt van een nette opzet',
          'Holdingstructuren die een Nederlandse werkmaatschappij nodig hebben',
        ],
      },
      included: {
        title: 'De opzet, stuk voor stuk',
        blocks: [
          {
            title: 'Structuur en naam',
            text: 'BV, filiaal of eenmanszaak, gekozen voor uw situatie, plus een handelsnaamcheck voordat u iets laat drukken.',
          },
          {
            title: 'Notariscoördinatie',
            text: 'Een BV wordt opgericht bij Nederlandse notariële akte. Wij briefen de notaris, bereiden de aandeelhoudersgegevens voor en regelen het passeren, ook met oprichters die nog in het buitenland zijn.',
          },
          {
            title: 'KvK- en belastingregistratie',
            text: 'Inschrijving in het Handelsregister, de UBO-opgave en het btw-nummer van de Belastingdienst waarmee u kunt factureren.',
          },
          {
            title: 'Zakelijk bankieren',
            text: 'Nederlandse banken zijn voorzichtig met buitenlandse oprichters. Wij bereiden het dossier voor dat hun compliancevragen beantwoordt en introduceren u waar wij kunnen.',
          },
          {
            title: 'Vestigingsadres',
            text: 'Elk Nederlands bedrijf heeft een echt adres nodig. Wij helpen u een pand of een compliant vestigingsadres te regelen voordat de registraties beginnen.',
          },
        ],
      },
      process: {
        title: 'Zo verloopt de oprichting',
        steps: [
      ...
      faq: {
        ...
        items: [
          {
            q: 'Moet ik in Nederland zijn om op te richten?',
            a: 'Niet per se. Een BV kan met een volmacht worden opgericht terwijl u in het buitenland bent, en wij coördineren de gelegaliseerde handtekeningen die de notaris vereist.',
          },
          {
            q: 'BV of eenmanszaak, wat moet ik kiezen?',
            a: 'Een BV beperkt de aansprakelijkheid en past bij groei en investeerders; een eenmanszaak is lichter en goedkoper in beheer. Belasting- en immigratiefactoren geven per geval de doorslag, dus wij adviseren op uw cijfers, niet op een vuistregel.',
          },
          {
            q: 'Hoeveel aandelenkapitaal heeft een BV nodig?',
            a: 'De Nederlandse wet staat toe dat een BV wordt opgericht met een symbolisch aandelenkapitaal, zelfs één eurocent. Wat telt is een kapitalisatie die past bij uw bedrijfsplan en, waar relevant, uw vergunningsvoorwaarden.',
          },
        ],
      },
      cta: {
        title: 'Richt het goed op, in één keer',
        text: 'Vertel ons wat het bedrijf gaat doen en van wie het is. Wij stellen de structuur voor en zetten de klok aan.',
    ...
    },
    {
      ...
      menuLabel: 'KvK-inschrijving',
      title: 'KvK-inschrijving voor buitenlanders',
      metaTitle: 'KvK-inschrijving voor buitenlanders | Kamer van Koophandel',
      metaDescription:
        'Schrijf u als buitenlander zonder verwarring in bij de Kamer van Koophandel. Afspraakvoorbereiding, documenten, SBI-codes en persoonlijke begeleiding naar de KvK.',
      eyebrow: 'Kamer van Koophandel',
      intro: [
        'Elk bedrijf in Nederland begint bij de Kamer van Koophandel, en voor buitenlanders is de KvK-afspraak het moment waarop papierwerk de werkelijkheid raakt: identificatie, een Nederlands zakelijk adres, activiteitencodes en vragen gesteld in een systeem dat voor locals is gebouwd.',
      ...
      forWho: {
        ...
        items: [
          'Freelancers en zzp’ers die een eenmanszaak inschrijven',
          'DAFT-aanvragers van wie de vergunning een KvK-inschrijving vereist',
          'EU-burgers die in Nederland zelfstandig gaan werken',
          'Oprichters die niet zeker weten welke activiteiten en codes ze moeten registreren',
        ],
      },
      included: {
        title: 'Rond uw inschrijving',
        blocks: [
          {
            title: 'Documenten doorgenomen',
            text: 'Paspoort, adresbewijs en bewijs van uw bedrijfsactiviteiten, getoetst aan de KvK-eisen voordat wij iets boeken.',
          },
          {
            title: 'Oplossingen voor een zakelijk adres',
            text: 'De KvK vereist een echt Nederlands zakelijk adres, en een hotelkamer telt niet. Wij helpen u er een te regelen dat zowel de KvK als de Belastingdienst tevreden stelt.',
          },
          {
            title: 'SBI-codes en omschrijving',
            text: 'Uw geregistreerde activiteiten werken door in verzekeringen, bankzaken en belastingen. Wij kiezen de codes weloverwogen in plaats van ter plekke aan de balie.',
          },
          {
            title: 'Afspraak en afronding',
            text: 'Wij boeken de afspraak, wonen deze met u bij en bevestigen achteraf dat uw KvK-nummer, uittreksel en btw-registratie allemaal aankomen zoals het hoort.',
          },
        ],
      },
      process: {
        title: 'In drie stappen naar uw KvK-nummer',
        steps: [
      ...
      faq: {
        ...
        items: [
          {
            q: 'Kan ik mij bij de KvK inschrijven zonder al in Nederland te wonen?',
            a: 'In sommige gevallen wel, als uw bedrijf werkelijk vanaf een Nederlands adres opereert. De opzet verschilt van een inschrijving als ingezetene, en wij beoordelen wat op u van toepassing is.',
          },
          {
            q: 'Wat kost een KvK-inschrijving?',
            a: 'De KvK rekent een bescheiden eenmalige inschrijfvergoeding, die periodiek verandert. Wij bevestigen het actuele bedrag wanneer wij uw afspraak boeken, en daarna volgen geen verborgen kosten.',
          },
          {
            q: 'Krijg ik mijn btw-nummer bij de KvK?',
            a: 'De KvK geeft uw inschrijving door aan de Belastingdienst, die vervolgens het btw-nummer uitgeeft. Wij volgen die overdracht, zodat u niet in stilte zit te wachten zonder te kunnen factureren.',
          },
        ],
      },
      cta: {
        title: 'Laten we u inschrijven',
        text: 'Stuur ons uw situatie en uw gewenste startdatum. Wij bereiden alles voor en boeken de KvK samen.',
    ...
    },
    {
      ...
      menuLabel: 'Ondernemersrelocation',
      title: 'Relocation services voor ondernemers Nederland',
      metaTitle: 'Relocation services voor ondernemers Nederland | E & I',
      metaDescription:
        'Relocation ontworpen voor ondernemers die naar Nederland verhuizen: vergunningen, huis, gezin en bedrijf opgezet als één project, met één persoonlijk aanspreekpunt.',
      eyebrow: 'Relocation',
      intro: [
        'Een werknemer die verhuist heeft een HR-afdeling. Een ondernemer die verhuist heeft een takenlijst die terugvecht: een vergunning die afhangt van een bedrijf, een bedrijf dat een adres nodig heeft, een adres dat een inschrijving nodig heeft, en een gezin dat op dat alles wacht. Standaard relocationpakketten zijn niet gebouwd voor die circulaire puzzel.',
        'Het onze wel. Wij voeren uw verhuizing uit als één project met één eigenaar, en omdat vragen niet wachten op kantooruren, bereikt u ons 24/7 via een persoonlijke WhatsApp-lijn, van de eerste ingepakte doos tot het laatste getekende formulier.',
      ],
      cardText: 'De verhuizing, de vergunning, het bedrijf en het gezin, uitgevoerd als één project.',
      forWho: {
        title: 'Ondernemers die wij verhuizen',
        items: [
          'Oprichters die zichzelf en hun bedrijf tegelijk verplaatsen',
          'Zelfstandige professionals op een DAFT- of zelfstandigenvergunning',
          'Ondernemers die een partner en kinderen meenemen',
          'Bedrijfseigenaren die alles op afstand probeerden te regelen en vastliepen',
        ],
      },
      included: {
        title: 'Eén project, elke draad',
        blocks: [
          {
            title: 'Volgorde die werkt',
            text: 'Wij ordenen de stappen voor vergunning, bedrijf, woonruimte en inschrijving zo dat elke stap de volgende ontgrendelt in plaats van blokkeert.',
          },
          {
            title: 'Woningzoektocht met bedrijfslogica',
            text: 'Een huis dat past bij uw gezin en standhoudt als inschrijfadres voor u en, waar verstandig, uw bedrijf.',
          },
          {
            title: 'Administratieve landing',
            text: 'Gemeente-inschrijving, BSN, zorgverzekering en de Nederlandse praktische zaken zoals DigiD, geregeld in uw eerste weken.',
          },
          {
            title: 'Settelen van het gezin',
            text: 'Scholen, kinderopvang en buurtoriëntatie voor de mensen die dit avontuur niet kozen maar het wel met u beleven.',
          },
        ],
      },
      process: {
        title: 'Zo ontvouwt uw verhuizing zich',
        steps: [
      ...
      faq: {
        ...
        items: [
          {
            q: 'Kunt u de hele verhuizing regelen of alleen delen ervan?',
            a: 'Beide. De meeste ondernemers geven ons het complete project, maar u kunt ons ook inschakelen voor het stuk dat vastzit, meestal de woonruimte of de vergunningsvolgorde.',
          },
          {
            q: 'Wanneer moet ik u betrekken, vóór of na mijn vergunning?',
            a: 'Ervoor, idealiter. De vergunningsroute beïnvloedt de bedrijfsstructuur en zelfs waar u zou moeten wonen. Ons vroeg betrekken voorkomt duur overdoen.',
          },
          {
            q: 'Werkt u met ondernemers buiten de Randstad?',
            a: 'Ja. Wij werken door heel Nederland, met bijzondere diepgang rond Rotterdam en de zuidelijke industriële regio waar veel van onze cliënten hun bedrijven bouwen.',
          },
        ],
      },
      cta: {
        title: 'Verhuis alsof het uw beste zakelijke beslissing is',
        text: 'Vertel ons waar u staat: vergunning, bedrijf, gezin, woonruimte. Wij laten u de volgorde zien die u het snelst gesetteld krijgt.',
    ...
    },
    {
      ...
      intro: [
        ...
        'Wij zijn gebouwd voor beide, en ons thuisterrein is de industriële regio van Rotterdam, Europoort en de Maasvlakte, waar internationale bedrijven in energie, logistiek en offshore hun Europese activiteiten laten landen. Wij verhuizen complete teams en hun gezinnen als één gecoördineerd programma.',
      ],
      cardText: 'Corporate relocations die de entiteit, het team en elk gezin erachter verplaatsen.',
      forWho: {
        title: 'Wie ons inschakelt',
        items: [
          'Internationale bedrijven die een Nederlands kantoor, fabriek of filiaal openen',
          'Firma’s die een team specialisten en hun gezinnen in één keer overplaatsen',
          'HR- en mobilitymanagers die één aanspreekbare lokale partner nodig hebben',
          'Bedrijven in haven, energie, logistiek en offshore die zich in de regio vestigen',
        ],
      },
      included: {
        title: 'Het corporate programma',
        blocks: [
          {
            title: 'Entiteit en compliance',
            text: 'Nederlandse entiteit of filiaal opgericht, geregistreerd en klaar om personeel in dienst te nemen, afgestemd met uw juridische en fiscale adviseurs.',
          },
          {
            title: 'Erkend referentschap en vergunningen',
            text: 'Wij begeleiden uw bedrijf waar nodig door het IND-erkend referentschap en verzorgen de werkvergunningaanvragen voor elke overkomende werknemer.',
          },
          {
            title: 'Relocation voor meerdere gezinnen',
            text: 'Elk gezin krijgt een eigen woningzoektocht, schoolplaatsingen en setteltraject, parallel uitgevoerd zodat het hele team volgens schema start.',
          },
          {
            title: 'Eén dashboard voor HR',
            text: 'Eén aanspreekpunt en een helder overzicht van waar elke werknemer en elk gezin staat, in plaats van dertig verspreide e-mailthreads.',
          },
          {
            title: 'Nazorg die mensen behoudt',
            text: 'De eerste maanden bepalen of gezinnen blijven. Wij blijven na aankomst beschikbaar voor uw werknemers, en dat beschermt de investering die u in hun verhuizing deed.',
          },
        ],
      },
      process: {
        title: 'Van besluit tot operationeel',
        steps: [
      ...
      faq: {
        ...
        items: [
          {
            q: 'Hoeveel werknemers kunt u tegelijk verhuizen?',
            a: 'Ons model is bewust boutique: minder programma’s, grondig uitgevoerd. Wij nemen teamrelocations aan op een schaal waarbij elk gezin nog persoonlijke aandacht krijgt, en wij zijn eerlijk wanneer een verzoek daar overheen gaat.',
          },
          {
            q: 'Kunt u samenwerken met onze bestaande juridische of fiscale adviseurs?',
            a: 'Ja, en dat heeft zelfs onze voorkeur. Wij coördineren de praktische en menselijke kant en voegen ons in de structuur die uw adviseurs ontwerpen.',
          },
          {
            q: 'Wat kost een corporate relocation?',
            a: 'Dat hangt af van het aantal mensen, de gezinsgroottes en de woonwensen. Wij bepalen eerst de scope en offreren een helder projecttarief, geen uurtje-factuurtje dat op de achtergrond doorloopt.',
          },
        ],
      },
      cta: {
        title: 'Verplaats het bedrijf. Behoud de mensen.',
        text: 'Vertel ons de omvang van het team en de streefdatum. Wij komen terug met een programmaopzet en een realistische tijdlijn.',
    ...
    },
    {
      ...
      menuLabel: 'Woonruimte voor ondernemers',
      title: 'Woonruimte voor ondernemers Nederland',
      metaTitle: 'Woonruimte voor ondernemers in Nederland | E & I',
      metaDescription:
        'Woonbegeleiding voor ondernemers in Nederland: huren zonder loonstroken, adressen met inschrijfmogelijkheid en persoonlijk bijgewoonde bezichtigingen in een krappe markt.',
      eyebrow: 'Wonen',
      intro: [
        'De Nederlandse woningmarkt is hard voor iedereen en het hardst voor ondernemers. Verhuurders willen loonstroken en werkgeversverklaringen; u heeft een jong bedrijf, buitenlandse bankafschriften en een sterk verhaal waar niemand op een drukke bezichtiging naar blijft luisteren.',
        'Wij vertellen dat verhaal voor u. Wij weten welke verhuurders en makelaars ondernemersinkomen accepteren, hoe je het dossier van een oprichter zo presenteert dat het wint van biedende loondienstkandidaten, en wij wonen bezichtigingen bij met u of voor u wanneer u nog in het buitenland bent.',
      ],
      cardText: 'Huurwoningen winnen zonder loonstroken: dossiers, bezichtigingen en onderhandelingen voor oprichters.',
      forWho: {
        title: 'Wie dit nodig heeft',
        items: [
          'Oprichters die aankomen op een startup-, DAFT- of zelfstandigenvergunning',
          'Ondernemers van wie het inkomen reëel is maar niet past in standaard checklijsten van verhuurders',
          'Bedrijfseigenaren die vanuit het buitenland zoeken en niet bij bezichtigingen kunnen zijn',
          'Gezinnen van ondernemers die een huis nodig hebben nabij scholen en het bedrijf',
        ],
      },
      included: {
        title: 'Zo winnen wij een huis voor u',
        blocks: [
          {
            title: 'Een dossier dat verhuurders overtuigt',
            text: 'Bedrijfscijfers, contracten en referenties verpakt in het format dat Nederlandse verhuurders en makelaars werkelijk vertrouwen van zelfstandige huurders.',
          },
          {
            title: 'Gerichte zoektocht',
            text: 'Wij zoeken waar uw inschrijving, reistijd en gezinsbehoeften samenkomen, inclusief off-market woningen via ons makelaarsnetwerk.',
          },
          {
            title: 'Bezichtigingen, bijgewoond',
            text: 'Wij bezichtigen met u, of op video voor u, en geven u een eerlijk oordeel over de straat, het gebouw en de contractvoorwaarden.',
          },
          {
            title: 'Onderhandeling en contractcheck',
            text: 'Prijs, borg en clausules onderhandeld, en het huurcontract beoordeeld voordat u tekent, inclusief of het adres bedrijfsregistratie toestaat.',
          },
        ],
      },
      process: {
        title: 'De zoektocht, gestructureerd',
        steps: [
      ...
      faq: {
        ...
        items: [
          {
            q: 'Kan ik huren zonder Nederlandse loonstroken?',
            a: 'Ja, met de juiste presentatie. Verhuurders accepteren ondernemersinkomen wanneer het overtuigend is gedocumenteerd, en sommigen vragen extra borg of vooruitbetaalde huur. Wij onderhandelen die voorwaarden naar iets redelijks.',
          },
          {
            q: 'Kan ik mijn bedrijf op mijn woonadres registreren?',
            a: 'Vaak wel, als het huurcontract het toestaat en de activiteiten passen bij een woonomgeving. Wij controleren het contract en de gemeentelijke regels voor uw specifieke geval voordat u tekent.',
          },
          {
            q: 'Hoe snel kunt u iets vinden?',
            a: 'Dat hangt af van budget en gebied, en wij vertellen u bij de intake eerlijk wat uw criteria in de huidige markt opleveren. Wat wij nooit doen is u laten invliegen zonder plan voor waar u slaapt en zich inschrijft.',
          },
        ],
      },
      cta: {
        title: 'Vind een huis dat net zo hard werkt als u',
        text: 'Deel uw budget, uw gebieden en uw verhuisdatum. Wij vertellen u wat realistisch is en starten de zoektocht deze week.',
  ...
  crossLinks: [
    {
      ...
      label: 'Startup visum',
      text: 'Een oprichtersvergunning van één jaar om uw innovatieve bedrijf te bouwen met een erkende facilitator.',
    },
    {
      path: '/immigration/daft-visa-netherlands',
      label: 'DAFT visum',
      text: 'De verdragsroute waarmee Amerikanen in Nederland kunnen wonen en werken met een bedrijfsinvestering van € 4.500.',
    },
  ],
};
