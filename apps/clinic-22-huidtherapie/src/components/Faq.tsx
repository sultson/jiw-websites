...
export default function Faq({ t, onBook }: Props) {
  ...
  return (
    <section id="faq" className="py-20 md:py-28 bg-bone/55">
                  ...
                  i === 2 ? (
                    <div className="pb-6 space-y-4">
                      <p className="text-ink/70 leading-relaxed">
                        ...
                        <button
                          onClick={onBook}
                          className="underline underline-offset-2 decoration-ink/40 hover:text-ink transition-colors"
                        >
                          {t('faq.a2.book')}
                        </button>
                        {t('faq.a2.p2')}
                      ...
                      <div className="flex flex-wrap gap-3">
                        <a
                          href="tel:+31613372711"
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-ink/20 text-sm text-ink/80 hover:bg-ink hover:text-ivory transition-colors"
                        >
                          <Phone size={14} />
                          {t('faq.a2.call')}
                        </a>
