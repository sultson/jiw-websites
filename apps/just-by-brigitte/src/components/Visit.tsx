      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          <div className="card p-6 md:p-8 space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Kardinaal+de+Jongstraat+97+Valkenswaard"
                  target="_blank"
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a href="tel:+31614888512" className="font-medium text-espresso mt-1 block hover:text-gold">
                  06 14888512
                </a>
                <a
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-4">
                  ...
                  <a
                    href="https://www.facebook.com/justnailsvalkenswaard/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-sm text-espresso hover:text-gold"
                  >
          ...
          <div className="rounded-2xl overflow-hidden border border-espresso/5 min-h-[360px] md:min-h-full">
            <iframe
              title="Just by Brigitte op Google Maps"
              src="https://www.google.com/maps?q=Just+by+Brigitte+Valkenswaard&output=embed"
              width="100%"
              height="100%"
