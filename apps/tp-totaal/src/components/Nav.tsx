...
function Wordmark() {
  return (
    <a href="#top" className="flex items-center gap-3" aria-label="TP Totaal home">
      <span
        aria-hidden="true"
        className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-ink text-bone font-display font-bold text-base tracking-tight"
      >
        TP
      </span>
      <span className="flex flex-col leading-none">
        <span className="font-display text-xl md:text-2xl text-ink">TP Totaal</span>
        <span className="font-sans text-[10px] tracking-[0.24em] text-stone uppercase mt-0.5">
          Project Onderhoud
        </span>
      </span>
    </a>
      ...
      <div className="container-page flex items-center justify-between py-4 md:py-5">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-semibold text-ink hover:text-brick-deep"
          >
