  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-full bg-brick text-bone font-semibold pl-5 pr-6 py-3.5 shadow-[0_12px_30px_-8px_rgba(195,80,42,0.55)] transition-all duration-300 ${
