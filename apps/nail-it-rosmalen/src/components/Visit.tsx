...
import { hours, formatSegments } from '../data/hours';
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          <div className="card p-6 md:p-8 space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Pr.+Margrietstraat+Rosmalen+5246+XS"
                  target="_blank"
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a href="tel:+31639211983" className="font-medium text-espresso mt-1 block hover:text-gold">
                  06 39211983
                </a>
                <a
                  ...
                  {hours.map(h => (
                    ...
                    >
                      ...
                      <span className="tabular-nums">
                        {formatSegments(h, t('visit.closed'))}
                        {h.marked && <span className="text-gold ml-0.5">*</span>}
                      </span>
                    </li>
                  ))}
                </ul>
                <p className="mt-3 text-xs text-espresso/55">{t('visit.holidaysClosed')}</p>
                <p className="mt-1 text-xs italic text-espresso/55">
                  <span className="text-gold not-italic">*</span> {t('visit.hoursNote')}
                </p>
              </div>
            </div>
          ...
          <div className="rounded-2xl overflow-hidden border border-espresso/5 min-h-[360px] md:min-h-full">
            <iframe
              title="Nagelstudio Nail It op Google Maps"
              src="https://www.google.com/maps?q=Nagelstudio+Nail+It+Rosmalen&output=embed"
              width="100%"
              height="100%"
