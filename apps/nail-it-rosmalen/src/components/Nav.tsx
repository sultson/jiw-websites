  ...
  return (
    <>
      <div className="sticky top-0 z-[60] bg-espresso text-cream text-center py-2 px-4">
        <p className="text-[11px] tracking-wider">{activeVacationNotice(lang) ?? t('topbar.new')}</p>
      </div>
      <nav
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            <a href="#top" className="flex items-baseline gap-2 min-w-0" aria-label="Nagelstudio Nail It">
              <span className="font-serif text-xl md:text-2xl italic tracking-tight truncate">
                Nail<span className="text-gold">·</span>It
              </span>
              <span className="hidden sm:inline text-[10px] uppercase tracking-[0.25em] text-espresso/45">
                Rosmalen
              </span>
            </a>
