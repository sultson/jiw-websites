...
const links = [
  ...
  { href: '#specialiteiten', key: 'nav.special' },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          <a href="#top" aria-label="Nagelsalon Liana" className="flex items-center min-w-0">
            <span className="font-serif text-xl md:text-2xl tracking-wide text-espresso">
              Nagelsalon <span className="text-gold">Liana</span>
            </span>
          </a>
