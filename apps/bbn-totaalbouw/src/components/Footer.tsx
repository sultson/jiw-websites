        ...
        <div className="grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {site.certifications.map(c => (
                <span
                  key={c}
                  className="rounded-md border border-bbn-line bg-bbn-ash px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-zinc-700"
                >
                  {c}
                </span>
              ))}
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                <a href={`tel:${site.phoneRaw}`} className="flex items-center gap-2 text-zinc-800 hover:text-bbn-red">
                  <Phone className="h-4 w-4" /> {site.phone}
                </a>
              </li>
              <li>
                <a href={`tel:${site.phoneOfficeRaw}`} className="flex items-center gap-2 text-zinc-800 hover:text-bbn-red">
                  <Phone className="h-4 w-4" /> {site.phoneOffice} (kantoor)
                </a>
              </li>
              <li>
                <a href={`mailto:${site.email}`} className="flex items-center gap-2 text-zinc-800 hover:text-bbn-red">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mt-4 text-sm text-zinc-800">{site.hours}</p>
            ...
            <p className="mt-3 text-sm text-zinc-800">{site.area}</p>
          </div>
        </div>
