    ...
    <section id="recensies" className="py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div className="mt-8 text-center">
          <a
            href="https://www.google.com/maps/place/De+Roza+Nagelstudio/@52.8855368,6.856702,657m/data=!3m1!1e3!4m8!3m7!1s0x47b7ddec1837b659:0x7632cb07b8e83c63!8m2!3d52.8855368!4d6.8592823!9m1!1b1!16s%2Fg%2F11k51d3xt5"
            target="_blank"
