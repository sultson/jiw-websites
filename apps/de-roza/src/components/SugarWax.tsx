import { Phone, MessageCircle, Sparkles, Check, X } from 'lucide-react';
...
export default function SugarWax({ t }: Props) {
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div>
                ...
                {benefits.map(i => (
                  <li key={i} className="flex items-start gap-3 text-cream/80 text-sm leading-relaxed">
                    <span className="mt-0.5 shrink-0 w-5 h-5 rounded-full bg-gold/20 border border-gold/30 flex items-center justify-center">
                      <Sparkles size={10} className="text-gold-soft" />
                    </span>
                    {t(`sugar.b${i}`)}
                  </li>
                ))}
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 border border-cream/40 text-cream px-6 py-3 rounded-full text-sm font-medium tracking-wide hover:bg-cream/10"
                style={{ minHeight: 44 }}
              >
          ...
          <div className="relative">
            <div className="aspect-[5/4] md:aspect-[3/4] rounded-2xl overflow-hidden bg-espresso-soft shadow-[0_30px_80px_-20px_rgba(0,0,0,0.5)]">
              <img
                src="/nail-detail.webp"
                alt="Gelmanicure bij De Roza"
