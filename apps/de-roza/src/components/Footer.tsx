        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            <span className="font-serif text-2xl text-cream">
              De Roza <span className="text-gold-soft">Nagelstudio</span>
            </span>
          ...
          <div className="space-y-2 text-sm">
            ...
            <a
              href="https://www.instagram.com/derozanagelstudio/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 hover:text-cream"
            >
              <Instagram size={14} className="text-gold-soft" /> @derozanagelstudio
            </a>
