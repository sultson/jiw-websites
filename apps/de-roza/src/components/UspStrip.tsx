import { Award, Leaf, Heart, Calendar } from 'lucide-react';

type Props = { t: (k: string) => string };

export default function UspStrip({ t }: Props) {
  const items = [
    { icon: Award,    title: t('usp.royx'),     sub: t('usp.royxSub') },
    { icon: Leaf,     title: t('usp.natural'),  sub: t('usp.naturalSub') },
    { icon: Heart,    title: t('usp.welcome'),  sub: t('usp.welcomeSub') },
