...
export const form = {
  ...
  houseNumber: { nl: 'Huisnummer', en: 'House number' },
  streetName: { nl: 'Straatnaam', en: 'Street' },
  city: { nl: 'Plaats', en: 'Town' },
  addressSearching: { nl: 'Adres zoeken...', en: 'Looking up address...' },
  addressNotFound: {
    nl: 'Adres niet gevonden. Vul uw straat en plaats zelf in.',
    en: 'Address not found. Enter your street and town yourself.',
  },
  ...
  errPostalValid: { nl: 'Vul een geldige postcode in.', en: 'Enter a valid postal code.' },
  errHouseNumber: { nl: 'Vul uw huisnummer in.', en: 'Enter your house number.' },
  errStreet: { nl: 'Vul uw straatnaam in.', en: 'Enter your street.' },
