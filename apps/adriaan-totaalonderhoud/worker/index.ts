...
const formWorker = createFormWorker({
  ...
  ownerName: 'Adriaan',
  senderName: 'Adriaan',
  subjectPrefix: 'Nieuwe offerteaanvraag',
  confirmationFollowUpSentence:
    'Adriaan neemt zo snel mogelijk contact met u op om uw aanvraag door te nemen en een afspraak in te plannen.',
  ...
  emailFields: [
    ...
    { name: 'propertyType', label: 'Type pand' },
    { name: 'urgency', label: 'Planning' },
  ],
