...
function Contact() {
  ...
  const intro = sectionTitles.contact.intro;
      ...
      <div className="container-page">
        ...
        <iframe
          src={`https://www.google.com/maps?q=${encodeURIComponent(
            `${business.address.street ? business.address.street + ', ' : ''}${business.address.postalCode} ${business.address.city}`,
          )}&output=embed`}
          loading="lazy"
          referrerPolicy="no-referrer-when-downgrade"
          title={`Kaart ${business.name}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <img
                src="/logo-full.webp"
                alt={business.name}
                className="h-16 w-auto bg-bone rounded-xl p-2"
              />
              <p className="mt-4 text-bone/70 text-sm">{business.tagline}</p>
            </div>
