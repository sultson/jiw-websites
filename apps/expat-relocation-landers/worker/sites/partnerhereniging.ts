...
const DOMAIN = 'partnerhereniging.nl';
const SITE_NAME = 'Immigration Services NL';
const PREVIEW_ORIGIN = 'https://partnerhereniging.jouwidealewebsite.nl';
...
const qualify = createFormWorker({
  formPath: '/api/forms/partner-qualify',
  siteName: SITE_NAME,
  senderName: SITE_NAME,
  ownerName: 'Johanna',
  ...
  emailFields: [
    ...
    { name: 'location', label: 'Partner woont op dit moment' },
    { name: 'situation', label: 'Relatievorm' },
    { name: 'exam', label: 'Basisexamen buitenland' },
    { name: 'nationality', label: 'Nationaliteit van de partner' },
    { name: 'arrival', label: 'Gewenst moment van indienen' },
    { name: 'language', label: 'Taal van de pagina' },
    { name: 'domain', label: 'Domein' },
  ],
  leadEmail: {
...
export const partnerherenigingForms = [
  { path: '/api/forms/partner-qualify', worker: qualify },
  { path: '/api/forms/partner', worker: lead },
];
