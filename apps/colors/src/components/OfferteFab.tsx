...
export default function OfferteFab() {
  ...
  useEffect(() => {
    const onScroll = () => setScrolledPast(window.scrollY > window.innerHeight * 0.5);
    onScroll();
  ...
  return (
    ...
    >
      <a
        ...
        className="flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-[0_10px_28px_-8px_rgba(37,211,102,0.55)] hover:scale-105 transition-transform duration-300"
      >
      ...
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-full bg-rood text-white font-semibold pl-5 pr-6 py-3.5 shadow-[0_14px_30px_-8px_rgba(232,40,30,0.6)] transition-all duration-300 ${
