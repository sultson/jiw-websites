...
function Wordmark({ light = false }: { light?: boolean }) {
  return (
    <a href="#top" className="flex items-center gap-3" aria-label="Color's Schildersbedrijf home">
      <img src="/logo-compact.webp" alt="" className="h-10 w-10 md:h-11 md:w-11" />
      <span className="flex flex-col leading-none">
        <span
          className={`font-display text-2xl md:text-[1.6rem] font-extrabold tracking-tight ${
        ...
        <span
          className={`font-sans text-[10px] tracking-[0.28em] uppercase mt-1 ${
...
export default function Nav() {
  ...
  return (
    ...
    >
      <div className="container-page flex items-center justify-between py-3 md:py-4">
        ...
        <nav className="hidden md:flex items-center gap-9">
          {links.map((l) => (
            <a
              key={l.href}
              href={l.href}
              className="font-sans text-sm text-ink hover:text-rood transition-colors"
            >
              {l.label}
            </a>
          ))}
        ...
        <div className="hidden md:flex items-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-semibold text-ink hover:text-rood"
          >
      ...
      <div className="rainbow-strip mx-4 md:mx-8 mb-0 opacity-90" />
      ...
      >
        ...
        <div className="rainbow-strip mx-4" />
        ...
        <div className="container-page flex flex-col gap-10 pt-12 pb-10">
          ...
          <div className="flex flex-col gap-3 items-start">
            ...
            <a href={business.phone.href} onClick={close} className="btn btn-ghost">
