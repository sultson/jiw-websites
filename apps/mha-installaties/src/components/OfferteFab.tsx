  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={open}
        aria-label="Vraag een gratis prijsindicatie aan"
        className={`md:hidden inline-flex items-center gap-2 rounded-full gold-gradient text-ink font-semibold pl-4 pr-5 py-3 shadow-[0_12px_30px_-8px_rgba(216,177,90,0.6)] transition-all duration-300 ${
